...
for w_tao = w
    for s = SS
        fprintf(['Sujetos...' num2str(31) '\n'])
        [X,fs] = organizar_all(SUBJECTS_DIR,31,tstart,tend);
%         y = y(:);
...
%                 end
        ...
        %             'msec'],'png')
        %% Saving results
        save([SUBJECTS_DIR filesep 'P_' num2str(s) '_'...
